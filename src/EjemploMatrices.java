public class EjemploMatrices   {
    public static void main(String[] args) {
        ...
        //se desborda el arreglo ya que supera al tamaño marcado numeros[0][4]=4;
        ...
        System.out.println("el primero elemnto es: " + numeros[0][0]);
        System.out.println("el ultimo elemento es: " + numeros[numeros.length-1][numeros[1].length-1]);
